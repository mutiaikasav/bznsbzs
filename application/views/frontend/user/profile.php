                    ...
                    <div class="col-lg-10">
                        <div class="profile">
                            ...
                            <div class="row col-lg-5">
                                <center>
                                    <img src="<?= base_url('assets/img/user/').$this->session->userdata('photo_user')?>" alt="" class="rounded-circle lozad">
                                </center>
                            </div>
                            <div class="row col-lg-4">
                                <center>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                            <div class="row col-lg-12">
                                                <form method="post" action="<?php base_url()?>/change-user">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label for="nama">Nama</label>
                                                        </div>
                                                        <div class="col-lg-8">
                                                            <input type="text" name="nama" id="nama" value="<?= @$this->session->name_user;?>">
                                                        </div>
                                                    </div>
                                                    <div class="row pt-3">
                                                        <div class="col-lg-4">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" name="username" id="username" <?= @$this->session->username_user;?>>
                                                        </div>
                                                    </div>
                                                    <div class="row pt-3">
                                                        <div class="col-lg-4">
                                                        ...
                                                        <div class="col-lg-8">
                                                            <input type="text" name="email" id="email" <?= @$this->session->email_user;?>>
                                                        </div>
                                                    </div>
                                                    <div class="row pt-3">
                                                        <div class="col-lg-4">
                                        ...
                                        <div class="tab-pane fade" id="v-pills-transaksi" role="tabpanel" aria-labelledby="v-pills-transaksi-tab">
                                            <div class="row col-lg-12">
                                                <h4>Transaksi</h4>
                                                <br>
                                                <table id="table_transaction" class="display">
                                                    <thead>
                                                        <tr>
                                                            <th>Column 1</th>
                                                            <th>Column 2</th>
